...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-slate-950/60 backdrop-blur border-b border-white/10">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        <a href="/" className="flex items-center gap-3">
          <motion.div initial={{ scale: .9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="w-9 h-9 rounded-lg bg-gradient-to-br from-sky-500 to-indigo-500 flex items-center justify-center text-white font-bold shadow-[0_8px_30px_-10px_rgba(56,189,248,0.7)]">ТТ</motion.div>
          <div>
